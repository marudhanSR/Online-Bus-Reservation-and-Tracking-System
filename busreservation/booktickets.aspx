<%@ Page Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="booktickets.aspx.cs" Inherits="booktickets" Title="Untitled Page" %>
...
<center><h1 style="font-size:20px; font-family:Arial;">Book Tickets</h1></center>
 <table align="center">
   <tr>
   <td>
   ...
   <td>
       <asp:TextBox ID="TextBox4" runat="server" ValidationGroup="admin" 
           AutoPostBack="True" ontextchanged="TextBox4_TextChanged"></asp:TextBox>  
      <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" ControlToValidate="TextBox4" ValidationGroup="admin"></asp:RequiredFieldValidator>
   </td>
   </tr>
     <tr>
   <td>
   ...
   <tr>
   <td>
       <asp:Button ID="Button1" runat="server" Text="Book" ValidationGroup="admin" 
